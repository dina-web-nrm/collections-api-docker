...
sleep 5
docker exec -i collectionsapidocker_db_1 mysql -u root -ppassword12 -e "create database dina_web;"
docker exec -i collectionsapidocker_db_1 mysql -u root -ppassword12 -D dina_web < mysql-autoload/DemoDatawImages.sql
